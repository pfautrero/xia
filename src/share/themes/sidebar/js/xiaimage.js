...
class XiaImage extends XiaDetail {
    ...
    defineHitArea() {
      ...
      var cropper = {
        ...
        'width' : Math.min(this.detail.maxX - this.detail.minX, Math.floor(this.parent.iaScene.originalWidth)),
        'height' : Math.min(this.detail.maxY - this.detail.minY, Math.floor(this.parent.iaScene.originalHeight))
      }
