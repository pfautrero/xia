...
\section{Creating your first image-active using Inkscape and Xia: \emph{Basic features}}
...
The tool "\chemin{Bezier curves}" is called by keeping the mouse button pressed 
...
Inkscape, go in the \chemin{File $\rightarrow$ Import} to incorporate your new image.
