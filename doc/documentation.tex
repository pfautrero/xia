...
% po4a: environement astuce {}
% po4a: environement alerte {}
% po4a: environement links {}
...
Then, you will learn how to create an enriched "image-active" (see section \ref{enriched_IA}). Final sections (section \ref{games_IA}) will teach you to create games.
