...
%\hline
%\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/accordionBlack}{accordionBlack}  & \raisebox{-5ex}{\includegraphics[scale=0.3]{./images/accordionBlack}} & Large comment zone, suitable for insertion of multimedia resources; to be used with vertical images (portrait)\\

%\hline
%\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/accordionCloud}
%{accordionCloud} &  \raisebox{-5ex}{\includegraphics[scale=0.3]{./images/accordionCloud}}& 
...
%\raisebox{-5ex}{\includegraphics[scale=0.3]{./images/buttonBlue}} & No lateral comment zone ; 
%comments appear above the image (suitable for long comments) ; users access  
%comments through icons placed above the image-active \\
%\hline
%\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/popBlue}{popBlue} & 
%\raisebox{-5ex}{\includegraphics[scale=0.3]{./images/popBlue}} & No lateral comment zone; 
%first click on the detail reveals it, and a second one pops up the comment 
%(no zoom) \\
%\hline
%\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/popYellow}{popYellow} & 
%\raisebox{-5ex}{\includegraphics[scale=0.3]{./images/popYellow}} & No lateral comment zone ; 
%first click on the detail reveals it, and a second one simultaneously unveils 
%the comment and the zoom function zoom on the detail\\
%\hline
%\end{tabular}
...
\tikzstyle{descrip}=[font=\sffamily, anchor=north west]
...
\begin{tikzpicture}
  ...
  \node[box, right = 3cm of bold] (bolR) {This text is \textbf{bold}};
  \node[anchor=north west, below = 1cm of bold] (italic) {\includegraphics[scale=.5]{./images/Description}};
  \node[descrip, below = -7mm of italic] (italicT) {This text is in **italic**};
  \node[box, right = 3cm of italic] (italicR) {This text is in \textit{italic}};
  \node[anchor=north west, below = 1cm of italic] (link) {\includegraphics[scale=.5]{./images/Description}};
  \node[descrip, below = 7mm of link.north] (linkT) {A link to };
  \node[descrip, below = 1mm of linkT] (linkTV) {\verb![https://www.wikipedia.org/Wikipedia]! };
  \node[box, right = 3cm of link] (linkR) {A link to \href{https://www.wikipedia.org/}{Wikipedia}}; 
  \node[anchor=north west, below = 1cm of link] (bullets) {\includegraphics[scale=.5]{./images/Description}};
  \node[descrip, below = -7mm of bullets] (bulletsT) {Making a list \\ * of bullets \\  * out of \\   * 2 levels};
  \node[box, right = 3cm of bullets] (bulletsR) {Making a list 
      \begin{itemize}
       \item of bullets
       \item out of
       \begin{itemize}
...
\begin{center}
  ...
  **italic** & \textit{italic}\\
  ...
  \hline
  \{\{\{Plain text\}\}\} & \raisebox{-2ex}{\includegraphics[scale=0.7]{./images/texte_brut}}\\
