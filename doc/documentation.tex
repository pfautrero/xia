...
\begin{tikzpicture}
  ...
  \node[anchor=north west, below = .4cm of bold] (italic) {\includegraphics[scale=.5]{./images/Description}};
  ...
  \node[anchor=north west, below = .4cm of italic] (link) {\includegraphics[scale=.5]{./images/Description}};
