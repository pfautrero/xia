...
the document} ;
 \item The text of the details is filled in the \softmenu{Object properties}, 
 in the \softmenu{Title} and \softmenu{Description} fields ;
...
Choose the template \softmenu{game1clic} to generate the interactive image.
...
If you indicate \verb|score2| in the \softmenu{onclick} field (\softmenu{Object Properties $\rightarrow$ Interactivity}) of the detail,
and if you use \texttt{<score2></score2>} and  \texttt{<message2></message2>} in the \softmenu{Object Properties} of the 
...
making the \softmenu{ID} field of the drop zone match
...
Choose the template \softmenu{gameDragAndDrop} to generate the interactive image.
...
Another method consists in inserting links in the \softmenu{Title} field of the \softmenu{Object Properties} 
...
on the background image: see section \ref{gameDragAndDropsection}.}, but you will apply the  \verb|<collisions>off</collisions>| tag to the drop zone's \softmenu{Description} field.
\newpage
\subsection{Abstract}
