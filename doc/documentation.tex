...
(\chemin{File $\rightarrow$ Open}).  When asked by the software
if you wish to "\chemin{Link}" or "\chemin{Incorporate image}", choose "\chemin
{Incorporate}".
...
through the way \chemin{File $\rightarrow$ Save as\ldots}. 
...
dropdown menu, choose the Inkscape svg file format. \chemin{SVG Inkscape (*.svg)}.
