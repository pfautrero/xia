...
When all the details are clipped and their metadatas indicated, Xia\ref{xia_interface} can be launched. You must select the svg source file with the top left icon,
