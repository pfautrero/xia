...
"size" line, where you have to indicate the size of the package even before you 
have zipped it.}.
\end{enumerate}
...
When the user will open the \texttt{deploy.html} file in the Firefox OS browser, its phone will download 
the interactive image and transform it in a html5 application.
