...
\begin{figure}[htp]
 ...
 \caption{The "\chemin{Object properties}" allows to enter the text that will become a 
...
\begin{tikzpicture}[%
  ...
  \node[manualT, callout absolute pointer={(5,0)}] at (10,0) {These files and folders  were manually created by the image-active designer. The \textcolor{bluedane}
