...
{Sélectionner la qualité de l'export}; \node[box,above right = 5mm of
aCloud.north east] (aBlackC)
...
\begin{links}
Visualisez
l'\href{http://xia.dane.ac-versailles.fr/demo/tuto/xia3}{"image-active"}
...
\begin{links}
Visualisez
l'\href{http://xia.dane.ac-versailles.fr/demo/tuto/xia5}{"image-active"}
créée pour cette partie de la documentation.
