...
\begin{links}
Visualisez
l'\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1}{"l'image
...
modèle d'export et un répertoire d'enregistrement de l'image interactive.
...
(textA.west) -- (4,-3);
\end{tikzpicture}
\caption{Fichiers d'une image interactive}
\label{xia_files}
\end{figure}
...
(aBlackC)
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/accordionBlack}{accordionBlack}\\ 
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/accordionCloud}{accordionCloud}\\ 
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/popYellow}{popYellow}\\ 
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/buttonBlue}{buttonBlue}\\ 
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/popBlue}{popBlue}\\ 
...
\begin{links}
Visualisez
l'\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia2}{"image
interactive"} créée pour cette partie de la documentation.
...
la barre latérale de l'image-active).
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/accordionCloud}{game1clic}\\ 
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/buttonBlue}{audioBrown}\\ 
...
{\href{http://images-actives.crdp-versailles.fr/beta/demo/tuto/xia1/popBlue}{gameDragAndDrop}\\ 
...
En indiquant \verb|score2| dans le champ \chemin{Description} des
\chemin{Propriétés de l'objet} du détail, et en utilisant les balises
...
Deux messages de fin peuvent donc apparaître, en fonction des types de
