...
{\href{http://geoffrey-gekiere.ac-versailles.fr/xia1/popBlue}{popBlue}\\ Pas
de zone latérale de commentaire; un premier clic met en évidence le détail,
un second fait apparaître le commentaire (pas de zoom)};
...
Texte à remplir et changer l'url};
