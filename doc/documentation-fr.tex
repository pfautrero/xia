...
le résultat final sur l'illustration ci-après\footnote{Les champs «~auteur~»
et «~droits~» apparaissent dans la fenêtre «~À propos~», symbolisée par
l'icône cliquable en forme de lettre «~i~».}:\\
...
qu'à glisser-déposer celle-ci à l'endroit désiré:\\
...
faire apparaître l'infobulle (par exemple, dans l'illustration ci-après: au
survol de la souris, le carré jaune fait apparaître une infobulle indiquant
"Test"):\\
