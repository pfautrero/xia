...
class Test(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertTrue(!driver.find_element_by_xpath("id('popup_text')/x:p[2]").is_displayed())
        self.assertEqual("Description de l'image", driver.find_element_by_xpath("id('collapsecomment')/x:div").text)
        self.assertTrue(!driver.find_element_by_xpath("id('collapsecomment')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "//div[@id='collapsecomment']/div/video"))
        self.assertTrue(!driver.find_element_by_xpath("//div[@id='collapsecomment']/div/video").is_displayed())
        ...
        self.assertTrue(!driver.find_element_by_xpath("id('collapse0')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('collapse0')/x:div/x:video"))
        self.assertTrue(!driver.find_element_by_xpath("id('collapse0')/x:div/x:video").is_displayed())
        ...
        self.assertTrue(!driver.find_element_by_xpath("id('collapse1')/x:div/x:ul/x:li[1]").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('collapse1')/x:div/x:img"))
        self.assertTrue(!driver.find_element_by_xpath("id('collapse1')/x:div/x:img").is_displayed())
        ...
        self.assertTrue(!driver.find_element_by_xpath("id('collapse2')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('collapse2')/x:div/x:img"))
        self.assertTrue(!driver.find_element_by_xpath("id('collapse2')/x:div/x:img").is_displayed())
        self.assertEqual("Description de ligne1", driver.find_element_by_xpath("id('collapse3')/x:div").text)
        self.assertTrue(!driver.find_element_by_xpath("id('collapse3')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('collapse3')/x:div/x:video"))
        self.assertTrue(!driver.find_element_by_xpath("id('collapse3')/x:div/x:video").is_displayed())
        self.assertEqual("Description de beziertracer une ligne", driver.find_element_by_xpath("id('collapse4')/x:div").text)
        self.assertTrue(!driver.find_element_by_xpath("id('collapse4')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('id('collapse4')/x:div/x:img"))
        self.assertTrue(!driver.find_element_by_xpath("id('id('collapse4')/x:div/x:img").is_displayed())
        self.assertEqual("le son 2 ! Réponse:LA réponse à la question", driver.find_element_by_xpath("id('collapse5')/x:div").text)
        self.assertTrue(!driver.find_element_by_xpath("id('collapse5')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('collapse5')/x:div/x:audio"))
        self.assertTrue(!driver.find_element_by_xpath("id('collapse5')/x:div/x:audio").is_displayed())
        self.assertEqual("le son 1 !", driver.find_element_by_xpath("id('collapse6')/x:div").text)
        self.assertTrue(!driver.find_element_by_xpath("id('collapse6')/x:div").is_displayed())
        self.assertTrue(self.is_element_present(By.XPATH, "id('collapse6')/x:div/x:audio"))
        self.assertTrue(!driver.find_element_by_xpath("id('collapse6')/x:div/x:audio").is_displayed())
